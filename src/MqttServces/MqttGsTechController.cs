...
namespace GsTechCoreV1.Api.Controllers.MQTT.GsTech
{
    ...
    public class MqttGsTechController : MqttBaseController
    {
        ...
        private readonly GsTechMqttService _mqttService;
        ...
        public MqttGsTechController(IMqttDbContext mqttDbContext, ILogger<MqttGsTechController> logger, GsTechMqttService mqttService,
            RestrictionRepository restrictionRepository, INeshanCacheRepository neshanCacheRepository, IWeatherCacheRepository weatherCacheRepository,
             INotificationService notificationService, IMQTTCacheRepository mQTTCacheRepository)
        {
