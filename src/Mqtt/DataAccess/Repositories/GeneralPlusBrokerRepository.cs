...
internal class GeneralPlusBrokerRepository(MqttReadDbContext readDbContext, MqttWriteDbContext writeDbContext, ILogger<GeneralPlusBrokerRepository> logger)
